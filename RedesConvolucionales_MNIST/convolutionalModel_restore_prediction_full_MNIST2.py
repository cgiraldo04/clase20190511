...
def model_predict(data_test, y_label, learning_rate = 0.009, num_epochs = 100, minibatch_size = 10, print_cost = True):
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, "F:\\DeepLearning\\04 Redes Neuronales Convolucionales\\RedesConvolucionales_MNIST\\model_softmax.ckpt")
...
img = cv2.imread("F:\\DeepLearning\\04 Redes Neuronales Convolucionales\\RedesConvolucionales_MNIST\\one.png")
